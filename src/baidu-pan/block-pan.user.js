...
(function () {
            ...
            <div id="downloadDialog">
                ...
                <div id="dialogMiddle">
                    <div id="dialogLeft">
                        ...
                        <div id="dialogQr" style="display: none" >
                ...
                <div id="dialogBottom">IDM下载必须改UA为：netdisk;3.0.0.112，否则IDM将报403无权限下载！！！</div>
            </div>
        `;
        showSwal(content, {
            button: '关 闭',
    ...
    /**
     * 获取当前已登录的百度网盘用户的uk和baidu_name，保存在全局变量uInfo中
     */
